...
export default function ManagerAll() {
  ...
  const load = () => {
    API.get('/api/attendance/all', {
      params: { employeeId: employeeId || undefined, date: date || undefined, status: status || undefined }
  ...
  return (
    <div className="card">
      ...
      <div className="filters">
        <input placeholder="Employee ID (EMP001)" value={employeeId} onChange={e => setEmployeeId(e.target.value)} />
